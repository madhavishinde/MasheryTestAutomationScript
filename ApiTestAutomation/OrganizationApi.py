        ...
        def add_budget_operation(self):
                ...
                try:
                        if not BaseClassApi.Api.payload:
                                ...
                                response = requests.post('https://api.dspbuilder.rubiconproject.com/api/v1/organizations/budget', verify=False, headers=headers, data=json.dumps(BaseClassApi.Api.payload))
                                status_code = response.status_code
                                print "\nResponse Status_code : %s" %status_code
                                print response.text
                                response.raise_for_status()
...
def execute_organization_api():
	...
	#This module uploads file i.e. json data and returns upload id.
        ...
        BaseClassApi.Api.general_id = org_api.create_operation()
	BaseClassApi.Api.general_id = "5541632370726f725d3e0000"
